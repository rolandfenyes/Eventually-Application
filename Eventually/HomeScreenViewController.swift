...
class HomeScreenViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //MARK: - Sample events
        let event1 = Event(eventName: "Mozizás", eventLocation: CLLocationCoordinate2D(latitude: 47.474838443055546, longitude: 19.049048381857574), numberOfPeople: "3", shortDescription: "Szeretnék mozizni menni pár emberrel.", startDate: "holnap", endDate: "valamikor", publicity: "publikus", image: UIImage(named: "cinema"), address: "Allee")
        ...
        let event3 = Event(eventName: "Burgerezés", eventLocation: CLLocationCoordinate2D(latitude: 47.37842513297852, longitude: 18.93373870756477), numberOfPeople: "3", shortDescription: "Sziasztok! Pár hete nyitott meg itt Érden a Burger King és szeretnék egy jót enni ott, viszont nincs kivel. Gondoltam ha van még valaki aki hasonló cipőben jár mint én, akkor itt majd találkozunk.", startDate: "Péntek este", endDate: "Szombat hajnal", publicity: "publikus", image: UIImage(named: "hamburger"), address: "Burger King Érd")
