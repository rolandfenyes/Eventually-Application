...
class HomeScreenViewController: UIViewController {
    ...
    func createSampleEvents() {
        //MARK: - Sample events
        let event1 = Event(eventName: "Mozizás", eventLocation: CLLocationCoordinate2D(latitude: 47.474838443055546, longitude: 19.049048381857574), numberOfPeople: "3", shortDescription: "Szeretnék mozizni menni pár emberrel.", startDate: "holnap", endDate: "valamikor", publicity: "Privát", image: UIImage(named: "cinema"), address: "Allee", creatorID: 1)
